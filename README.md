...
- 1 Limpar: Limpa todos os dados que estão preenchidos nos campos.
- 2 Cadastrar: Após preencher os campos, cadastra o funcionário com as informações digitadas.
- 3 Buscar: Busca no banco de dados pelo CPF o funcionário cadastrado anteriormente.
...
- Id: Mostra o ID do funcionário cadastrado no banco de dados.
